...
func TestExpandTypes(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"single mutation": {
			...
			ExpectedNames: []string{"AccountOutline", "AccountReference", "AlertableEntityOutline", "AlertsFillOption", "AlertsNrqlBaselineCondition", "AlertsNrqlBaselineDirection", "AlertsNrqlCondition", "AlertsNrqlConditionBaselineInput", "AlertsNrqlConditionExpiration", "AlertsNrqlConditionExpirationInput", "AlertsNrqlConditionPriority", "AlertsNrqlConditionQuery", "AlertsNrqlConditionQueryInput", "AlertsNrqlConditionSignal", "AlertsNrqlConditionSignalInput", "AlertsNrqlConditionTerms", "AlertsNrqlConditionTermsOperator", "AlertsNrqlConditionThresholdOccurrences", "AlertsNrqlConditionType", "AlertsNrqlDynamicConditionTermsInput", "AlertsNrqlDynamicConditionTermsOperator", "AlertsNrqlOutlierCondition", "AlertsNrqlStaticCondition", "AlertsNrqlStaticConditionValueFunction", "AlertsSignalAggregationMethod", "AlertsViolationTimeLimit", "ApmApplicationEntityOutline", "ApmApplicationRunningAgentVersions", "ApmApplicationSettings", "ApmApplicationSummaryData", "ApmBrowserApplicationEntityOutline", "ApmBrowserApplicationSummaryData", "ApmDatabaseInstanceEntityOutline", "ApmExternalServiceEntityOutline", "ApmExternalServiceSummaryData", "Boolean", "BrowserAgentInstallType", "BrowserApplicationEntityOutline", "BrowserApplicationRunningAgentVersions", "BrowserApplicationSettings", "BrowserApplicationSummaryData", "DashboardEntityOutline", "DashboardEntityOwnerInfo", "DashboardEntityPermissions", "DateTime", "EntityAlertSeverity", "EntityGoldenContext", "EntityGoldenContextInput", "EntityGoldenContextScopedGoldenMetrics", "EntityGoldenContextScopedGoldenTags", "EntityGoldenEventObjectId", "EntityGoldenMetric", "EntityGoldenMetricDefinition", "EntityGoldenMetricUnit", "EntityGoldenNrqlTimeWindowInput", "EntityGoldenTag", "EntityGuid", "EntityOutline", "EntityTag", "EntityType", "EpochMilliseconds", "ExternalEntityOutline", "Float", "GenericEntityOutline", "GenericInfrastructureEntityOutline", "ID", "InfrastructureAwsLambdaFunctionEntityOutline", "InfrastructureHostEntityOutline", "InfrastructureHostSummaryData", "InfrastructureIntegrationEntityOutline", "Int", "KeyTransactionEntityOutline", "Minutes", "MobileAppSummaryData", "MobileApplicationEntityOutline", "Nrql", "Seconds", "SecureCredentialEntityOutline", "SecureCredentialSummaryData", "ServiceLevelDefinition", "ServiceLevelEvents", "ServiceLevelEventsQuery", "ServiceLevelEventsQuerySelect", "ServiceLevelEventsQuerySelectFunction", "ServiceLevelIndicator", "ServiceLevelIndicatorResultQueries", "ServiceLevelObjective", "ServiceLevelObjectiveResultQueries", "ServiceLevelObjectiveRollingTimeWindow", "ServiceLevelObjectiveRollingTimeWindowUnit", "ServiceLevelObjectiveTimeWindow", "ServiceLevelResultQuery", "String", "SyntheticMonitorEntityOutline", "SyntheticMonitorStatus", "SyntheticMonitorSummaryData", "SyntheticMonitorType", "ThirdPartyServiceEntityOutline", "TimeWindowInput", "UnavailableEntityOutline", "UserReference", "WorkloadEntityOutline", "WorkloadStatus", "WorkloadStatusSource", "WorkloadStatusValue"},
		},
